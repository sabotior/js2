...
Container.prototype.render = function () {
    ...
    wrapper.className = this.className; //присвоили тегу class
...
var node = document.getElementById(this.id);//получаем элемент по id

node.parentElement.removeChild(node);//получаем радительский узел текущего элемента и передаем в метод removeChild текущий элемент
}
...
Menu.prototype.render = function () {
    ...
    ul.id = this.id; //присвоили тегу id
    ul.className = this.className; //присвоили тегу class
...
MenuItem.prototype.render = function () {
    ...
    li.className = this.className; //присвоили тегу class
